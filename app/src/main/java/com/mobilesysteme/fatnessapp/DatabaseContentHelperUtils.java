...
//        addRecipesWithIngredients(databaseHelper);
    ...
    private static void addFood(DatabaseHelper databaseHelper) {
        ...
        // 5 Hülsenfrüchte
        databaseHelper.addFood(5,"Belugalinsen", 1, 321, 100);
        ...
        databaseHelper.addFood(8,"Rapsöl", 2, 884, 100);
        ...
        databaseHelper.addFood(10,"Blumenkohl", 1, 25, 100);
        databaseHelper.addFood(10,"Brokkoli", 1, 35, 100);
        databaseHelper.addFood(10,"Bohnen, grün", 1, 29, 100);
        databaseHelper.addFood(10,"Champignons", 1, 22, 100);
        ...
        databaseHelper.addFood(10,"Fenchel", 1, 31, 100);
        databaseHelper.addFood(10,"Gurke", 1, 15, 100);
        databaseHelper.addFood(10,"Grünkohl", 1, 49, 100);
        databaseHelper.addFood(10,"Karotte", 1, 36, 100);
        databaseHelper.addFood(10,"Kartoffel", 1, 86, 100);
        databaseHelper.addFood(10,"Kohlrabi", 1, 27, 100);
        databaseHelper.addFood(10,"Kürbis, Hokkaido", 1, 63, 100);
        databaseHelper.addFood(10,"Lauch", 1, 31, 100);
        databaseHelper.addFood(10,"Mais", 1, 71, 100);
        databaseHelper.addFood(10, "Mangold", 1, 19, 100);
        databaseHelper.addFood(10,"Paprika, gelb", 1, 37, 100);
        databaseHelper.addFood(10,"Paprika, rot", 1, 43, 100);
        ...
        databaseHelper.addFood(10,"Spargel, grün", 1, 18, 100);
        databaseHelper.addFood(10,"Spargel, weiß", 1, 17, 100);
        databaseHelper.addFood(10,"Spinat", 1, 23, 100);
        databaseHelper.addFood(10,"Süßkartoffel", 1, 76, 100);
        databaseHelper.addFood(10,"Tomate", 1, 18, 100);
        databaseHelper.addFood(10,"Zucchini", 1, 20, 100);
        databaseHelper.addFood(10,"Zwiebel", 1, 28, 100);
        ...
        databaseHelper.addFood(11,"Kalbfleisch", 1, 95, 100);
        ...
        // 12 Fisch
        databaseHelper.addFood(12,"Forelle", 1, 107, 100);
        ...
        databaseHelper.addFood(13,"Tofu, geräuchert", 1, 165, 100);
        ...
        databaseHelper.addFood(15,"Couscous", 1, 376, 100);
        ...
        databaseHelper.addFood(16,"Butterkuchen", 1, 330, 100);
        ...
        databaseHelper.addFood(17,"Grünter Tee", 2, 1, 200);
        ...
        databaseHelper.addFood(18,"Rhabarberschorle", 2, 28, 200);
        ...
        databaseHelper.addFood(19,"Sekt", 2, 83, 100);
        ...
        databaseHelper.addFood(20,"Tomatensaft", 2, 18, 200);
        ...
        databaseHelper.addFood(21,"Spekulatius", 1, 484, 100);
        ...
        databaseHelper.addFood(22,"Gebratene Asia-Nudeln", 1, 342, 100);
        ...
        databaseHelper.addFood(22,"Veggie Burger", 1, 230, 100);
    }
